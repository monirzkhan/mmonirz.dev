                    ...
                    <div className="card card-border bg-base-100 w-56">
                        <div className="card-body">
                            <h2 className="card-title"><FaCode size={40} className="text-primary bg-black px-2 rounded" />
                                Frontend</h2>
                            <p>Building responsive, interactive interfaces with React, Next.js, and modern CSS frameworks.</p>
                        </div>
                    </div>
                    <div className="card card-border bg-base-100 w-56">
                        <div className="card-body">
                            <h2 className="card-title"><FaDatabase
                                ...
                                Backend</h2>
                            <p>Developing robust APIs, microservices, and server-side logic with Node.js, Express, and databases.</p>
                        </div>
                    </div>
                    <div className="card card-border bg-base-100 w-56">
                        <div className="card-body">
                            <h2 className="card-title"><GoStack size={40} className="text-primary bg-black px-2 rounded" />
                                Full Stack</h2>
                            <p>End-to-end development from database design to deployment, integrating frontend and backend seamlessly..</p>
                        </div>
                    </div>
                    <div className="card card-border bg-base-100 w-56">
                        <div className="card-body">
                            <h2 className="card-title"><VscThinking size={40} className="text-primary bg-black px-2 rounded" />
                                Ai Integration</h2>
                            <p>Exploring machine learning, intelligent automation, and AI-powered features for modern applications.</p>
                        </div>
                    </div>
                </div>
            </div>
